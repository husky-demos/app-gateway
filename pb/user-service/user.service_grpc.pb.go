...
func (c *userServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResult, error) {
	out := new(LoginResult)
	err := c.cc.Invoke(ctx, "/husky_demos.user_service.v1.UserService/login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/husky_demos.user_service.v1.UserService/login",
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "husky_demos.user_service.v1.UserService",
